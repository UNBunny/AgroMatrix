 ...
 * <p>get: L1 → miss → L2 → если hit, прогреваем L1.
 * <p>put: пишем в оба уровня. evict/clear: оба уровня.
 * <p>Если L2 недоступен — graceful degradation: WARN-лог и работа только на L1.
 */
@Slf4j
